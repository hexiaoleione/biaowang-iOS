...
#define APPID               @"wx2a86c51f04882974"//自己的APPID
#define SECRET              @"ebf0d5e90fd8945b486538754b3ecc1d"//自己的APPKEY
 ...
 *  微信授权后的操作
 */
+(void)WeixinLoginCode:(NSString *)code Success:(authSuccess)success Fail:(authFail)fail{
    ...
    [manager GET:url parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
        ...
        /*获取用户信息*/
//        NSString *url =[NSString stringWithFormat:@"https://api.weixin.qq.com/sns/userinfo?access_token=%@&openid=%@",_access_token,_open_ID];
