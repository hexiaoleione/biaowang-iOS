...
- (id)initWithFrame:(CGRect)frame WithTitle :(NSString *)title
{
    ...
    if (self)
    {
        ...
        ///  假的输入框
        _view_box = [[UIView alloc]initWithFrame:CGRectMake(40, 10, boxWidth, boxWidth)];
        [_view_box.layer setBorderWidth:1.0];
        _view_box.layer.borderColor = [[UIColor orangeColor]CGColor];
        [self addSubview:_view_box];
        _view_box2 = [[UIView alloc]initWithFrame:CGRectMake(50+boxWidth*1, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box2.layer setBorderWidth:1.0];
        _view_box2.layer.borderColor = [[UIColor orangeColor]CGColor];
        [self addSubview:_view_box2];
        _view_box3 = [[UIView alloc]initWithFrame:CGRectMake(60+boxWidth*2, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box3.layer setBorderWidth:1.0];
        _view_box3.layer.borderColor = [[UIColor orangeColor]CGColor];
        [self addSubview:_view_box3];
        _view_box4 = [[UIView alloc]initWithFrame:CGRectMake(70+boxWidth*3, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box4.layer setBorderWidth:1.0];
        _view_box4.layer.borderColor = [[UIColor orangeColor]CGColor];
        [self addSubview:_view_box4];
        _view_box5 = [[UIView alloc]initWithFrame:CGRectMake(80+boxWidth*4, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box5.layer setBorderWidth:1.0];
        _view_box5.layer.borderColor = [[UIColor orangeColor]CGColor];
        ...
        _view_box6.layer.borderColor = [[UIColor orangeColor]CGColor];
