...
+ (void)alipayWithPartner:(NSString *)partner
    ...
    // 调用支付接口
    [self payWithAppScheme:appScheme orderSpec:orderSpec signedString:signedString standbyCallback:completionBlock];
}
...
// 支付
+ (void)payWithAppScheme:(NSString *)appScheme orderSpec:(NSString *)orderSpec signedString:(NSString *)signedString standbyCallback:(CompletionBlock)completionBlock{
...
+ (NSString *)genTradeNoWithTime {
    ...
    NSLog(@"tradeNO %@", [NSString stringWithFormat:@"%d", tradeNo]);
