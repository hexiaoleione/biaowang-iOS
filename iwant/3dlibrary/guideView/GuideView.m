...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self addObserver:self forKeyPath:@"tips" options:NSKeyValueObservingOptionNew context:nil];
    }
    return self;
}
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context
{
    if ([keyPath isEqualToString:@"tips"]) {
        self.tipsLabel.text = [change objectForKey:NSKeyValueChangeNewKey];
...
- (void)dealloc
{
    [self removeObserver:self forKeyPath:@"tips"];
}
