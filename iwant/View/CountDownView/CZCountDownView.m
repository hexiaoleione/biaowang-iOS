...
//    self.secondsLabel.text = [NSString stringWithFormat:@"%zd秒",second];
    self.dayLabel.text = [NSString stringWithFormat:@"%zd时",hour];
    self.hourLabel.text = [NSString stringWithFormat:@"%zd分",minute];
    self.minuesLabel.text = [NSString stringWithFormat:@"%zd秒",second];
}
