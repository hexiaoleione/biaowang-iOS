...
-(void)layoutSubviews
{
    ...
    self.lable.frame = CGRectMake(CGRectGetMaxX(self.imageview.frame)+5*Kscr, 0, 300*Kscr, 45*Kscr);
    
    self.butten.frame = CGRectMake(self.frame.size.width-25*Kscr, 5*Kscr, 20*Kscr, 20*Kscr);
    self.butten.centerY = self.lable.centerY;
...
//    self.lable2.frame = CGRectMake(0, CGRectGetMaxY(self.lable1.frame)+10, self.frame.size.width, 20*Kscr);
    self.nnview.frame = CGRectMake(22.5*Kscr,  CGRectGetMaxY(self.lable1.frame)+10, 300*Kscr, 50*Kscr);
    self.lable.centerX = self.nnview.centerX;
