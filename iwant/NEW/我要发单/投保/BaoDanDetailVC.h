...
@interface BaoDanDetailVC : BaseViewController
...
@property (weak, nonatomic) IBOutlet AutoScrollLabel *startL;
@property (weak, nonatomic) IBOutlet AutoScrollLabel *endL;
