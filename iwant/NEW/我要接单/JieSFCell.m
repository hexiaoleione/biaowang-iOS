...
@implementation JieSFCell

- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
    self.topConstarint.constant = 8*RATIO_HEIGHT;
...
- (void)setModel:(ShunFengBiaoShi *)model{
    ...
    self.distanceL.text = [NSString stringWithFormat:@"运送距离：大约%0.2f公里",[model.distance floatValue]/1000];
