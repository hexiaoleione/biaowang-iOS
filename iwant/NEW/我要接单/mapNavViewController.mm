...
@interface mapNavViewController ()<BMKMapViewDelegate,BMKLocationServiceDelegate,BMKGeoCodeSearchDelegate,BMKRouteSearchDelegate>
{
...
- (void)viewDidLoad {
    ...
    _mapView = [[BMKMapView alloc]initWithFrame:CGRectMake(0,0,WINDOW_WIDTH,WINDOW_HEIGHT)];
