...
- (void)viewDidLoad {
    ...
    //阴影颜色
    self.segmentControl.layer.shadowColor = [UIColor blackColor].CGColor;
    //阴影横向和纵向的偏移值
    self.segmentControl.layer.shadowOffset = CGSizeMake(10, 10);
    //阴影透明度
    self.segmentControl.layer.shadowOpacity = 0.45;
...
- (XHSegmentControl *)segmentControl
{
    if (!_segmentControl)
    {
        float y = (!self.navigationController) ? 20.0:64.0;
